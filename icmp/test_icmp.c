...
{
    setup_test (NULL, "Unexpected path");
    NP_ASSERT_FALSE (watch_icmpv4_settings (ICMP_IPV4_PATH, "5"));
    NP_ASSERT_NULL (cmds);
}
...
void test_icmp4_invalid_parameter ()
{
    ...
    NP_ASSERT_TRUE (watch_icmpv4_settings (ICMP_IPV4_PATH "/speed", "5"));
    NP_ASSERT_NULL (cmds);
}
...
void test_icmpv4_dest_unreach_value_null ()
{
    ...
    NP_ASSERT_TRUE (watch_icmpv4_settings (ICMP_IPV4_SEND_DESTINATION_UNREACHABLE_PATH, NULL));
    NP_ASSERT_NULL (cmds);
}
...
{
    setup_test ("iptables -D ICMP -p icmp --icmp-type destination-unreachable -j DROP", NULL);
    NP_ASSERT_TRUE (watch_icmpv4_settings (ICMP_IPV4_SEND_DESTINATION_UNREACHABLE_PATH, "1"));
    NP_ASSERT_NULL (cmds);
}
...
void test_icmpv4_dest_unreach_disable ()
{
    ...
    NP_ASSERT_TRUE (watch_icmpv4_settings (ICMP_IPV4_SEND_DESTINATION_UNREACHABLE_PATH, "0"));
    NP_ASSERT_NULL (cmds);
}
...
void test_icmpv4_dest_unreach_value_invalid ()
{
    setup_test ("iptables -D ICMP -p icmp --icmp-type destination-unreachable -j DROP",
            "Invalid /icmp/ipv4/send-destination-unreachable value");
    NP_ASSERT_TRUE (watch_icmpv4_settings (ICMP_IPV4_SEND_DESTINATION_UNREACHABLE_PATH, "dog"));
    NP_ASSERT_NULL (cmds);
}
...
void test_icmpv4_error_ratelimit_value_null ()
{
    ...
    NP_ASSERT_TRUE (watch_icmpv4_settings (ICMP_IPV4_ERROR_RATELIMIT, NULL));
    NP_ASSERT_NULL (cmds);
}
...
void test_icmpv4_error_ratelimit_value_0 ()
{
    ...
    NP_ASSERT_TRUE (watch_icmpv4_settings (ICMP_IPV4_ERROR_RATELIMIT, "0"));
    NP_ASSERT_NULL (cmds);
}
...
void test_icmpv4_error_ratelimit_value_2147483647 ()
{
    ...
    NP_ASSERT_TRUE (watch_icmpv4_settings (ICMP_IPV4_ERROR_RATELIMIT, "2147483647"));
    NP_ASSERT_NULL (cmds);
}
...
void test_icmpv4_error_ratelimit_value_invalid ()
{
    ...
    NP_ASSERT_TRUE (watch_icmpv4_settings (ICMP_IPV4_ERROR_RATELIMIT, "dog"));
    NP_ASSERT_NULL (cmds);
}
...
{
    setup_test ("sysctl -w net.ipv4.icmp_ratelimit=1000", "Invalid ratelimit");
    NP_ASSERT_TRUE (watch_icmpv4_settings (ICMP_IPV4_ERROR_RATELIMIT, "-1"));
    NP_ASSERT_NULL (cmds);
}
...
{
    setup_test ("sysctl -w net.ipv4.icmp_ratelimit=1000", "Invalid ratelimit");
    NP_ASSERT_TRUE (watch_icmpv4_settings (ICMP_IPV4_ERROR_RATELIMIT, "2147483648"));
    NP_ASSERT_NULL (cmds);
}
...
{
    setup_test (NULL, "Unexpected path");
    NP_ASSERT_FALSE (watch_icmpv6_settings (ICMP_IPV6_PATH, "5"));
    NP_ASSERT_NULL (cmds);
}
...
{
    setup_test (NULL, NULL);
    NP_ASSERT_TRUE (watch_icmpv6_settings (ICMP_IPV6_PATH "/speed", "5"));
    NP_ASSERT_NULL (cmds);
}
...
void test_icmpv6_dest_unreach_value_null ()
{
    ...
    NP_ASSERT_TRUE (watch_icmpv6_settings (ICMP_IPV6_SEND_DESTINATION_UNREACHABLE_PATH, NULL));
    NP_ASSERT_NULL (cmds);
}
...
{
    setup_test ("ip6tables -D ICMP -p icmpv6 --icmpv6-type destination-unreachable -j DROP", NULL);
    NP_ASSERT_TRUE (watch_icmpv6_settings (ICMP_IPV6_SEND_DESTINATION_UNREACHABLE_PATH, "1"));
    NP_ASSERT_NULL (cmds);
}
...
void test_icmpv6_dest_unreach_disable ()
{
    ...
    NP_ASSERT_TRUE (watch_icmpv6_settings (ICMP_IPV6_SEND_DESTINATION_UNREACHABLE_PATH, "0"));
    NP_ASSERT_NULL (cmds);
}
...
void test_icmpv6_dest_unreach_value_invalid ()
{
    setup_test ("ip6tables -D ICMP -p icmpv6 --icmpv6-type destination-unreachable -j DROP",
            "Invalid /icmp/ipv6/send-destination-unreachable value");
    NP_ASSERT_TRUE (watch_icmpv6_settings (ICMP_IPV6_SEND_DESTINATION_UNREACHABLE_PATH, "dog"));
    NP_ASSERT_NULL (cmds);
}
...
void test_icmpv6_error_ratelimit_value_null ()
{
    ...
    NP_ASSERT_TRUE (watch_icmpv6_settings (ICMP_IPV6_ERROR_RATELIMIT, NULL));
    NP_ASSERT_NULL (cmds);
}
...
void test_icmpv6_error_ratelimit_value_0 ()
{
    ...
    NP_ASSERT_TRUE (watch_icmpv6_settings (ICMP_IPV6_ERROR_RATELIMIT, "0"));
    NP_ASSERT_NULL (cmds);
}
...
void test_icmpv6_error_ratelimit_value_2147483647 ()
{
    ...
    NP_ASSERT_TRUE (watch_icmpv6_settings (ICMP_IPV6_ERROR_RATELIMIT, "2147483647"));
    NP_ASSERT_NULL (cmds);
}
...
void test_icmpv6_error_ratelimit_value_invalid ()
{
    ...
    NP_ASSERT_TRUE (watch_icmpv6_settings (ICMP_IPV6_ERROR_RATELIMIT, "dog"));
    NP_ASSERT_NULL (cmds);
}
...
{
    setup_test ("sysctl -w net.ipv6.icmp_ratelimit=1000", "Invalid ratelimit");
    NP_ASSERT_TRUE (watch_icmpv6_settings (ICMP_IPV6_ERROR_RATELIMIT, "-1"));
    NP_ASSERT_NULL (cmds);
}
...
{
    setup_test ("sysctl -w net.ipv6.icmp_ratelimit=1000", "Invalid ratelimit");
    NP_ASSERT_TRUE (watch_icmpv6_settings (ICMP_IPV6_ERROR_RATELIMIT, "2147483648"));
    NP_ASSERT_NULL (cmds);
}
